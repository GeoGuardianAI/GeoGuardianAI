...
_RESCUE_TEAMS: list[RescueTeam] = [
    RescueTeam(
        ...
        name="Bengaluru Central Mountain Rescue",
    ...
    RescueTeam(
        ...
        name="Whitefield Fire Response Unit",
    ...
    RescueTeam(
        ...
        name="Yelahanka Urban Medical Team",
    ...
    RescueTeam(
        ...
        name="Electronic City Flood Recovery Crew",
    ...
    RescueTeam(
        ...
        name="Rajajinagar Disaster Response Group",
    ...
    RescueTeam(
        ...
        name="Bellandur Water Rescue Team",
        team_type=TeamType.WATER_RESCUE,
        latitude=12.9352,
        longitude=77.6245,
        members=10,
    ...
    RescueTeam(
        ...
        name="Devanahalli Wildfire Support Team",
        team_type=TeamType.FIRE_AND_RESCUE,
        latitude=13.1989,
        longitude=77.7068,
        members=9,
